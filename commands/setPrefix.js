...
module.exports = {
    ...
    execute(message) {
        if (!message.author.hasPermission('ADMINISTRATOR')) return message.channel.send('you need to have admin perms to change the prefix');
        ...
        return message.channel.send(`success! my prefix in this server has been changed to \`${newPrefix}\``);
    }
}